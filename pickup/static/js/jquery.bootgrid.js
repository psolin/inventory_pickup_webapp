    ...
    */
    ...
    Grid.defaults = {
        ...
        templates: {
            ...
            header: "<div id=\"{{ctx.id}}\" class=\"{{css.header}}\"><p class=\"{{css.search}}\" id=\"search-row\"></p><br/><br/><p class=\"{{css.actions}}\"></p></div>",
            ...
            search: "<div class=\"{{css.search}}\"><div class=\"input-group\"><span class=\"{{css.icon}} input-group-addon glyphicon-search\"></span> <input type=\"text\" class=\"{{css.searchField}}\" placeholder=\"{{lbl.search}}\" />",
